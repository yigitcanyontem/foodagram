...
public interface UsersEngagementRepository extends JpaRepository<UsersEngagement, UUID> {
    int countUsersEngagementsByUserIdAndUserEngagementType(UUID userId, UserEngagementType userEngagementType);
    int countUsersEngagementsByEngagedUserIdAndUserEngagementType(UUID engagedUserId, UserEngagementType userEngagementType);
